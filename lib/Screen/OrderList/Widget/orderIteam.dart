            ...
            await Navigator.push(
              ...
              CupertinoPageRoute(
                builder: (context) => OrderDetail(
                 ...
                 update: update,orderDate: model.orderDate,
                  otp: model.itemList![0].otp,
                  payment: model.payMethod,
                  orderImages: model.itemList![0].image,
                  orderQTY: model.itemList![0].qty,
                  orderPrice: model.itemList![0].price,
                  mobile: model.mobile,
                  orderName: model.itemList![0].name,

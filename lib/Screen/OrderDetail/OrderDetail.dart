...
class OrderDetail extends StatefulWidget {
  final String? id,orderDate,payment,otp,orderImages,orderQTY,orderPrice,itemId,mobile,orderName,userName,userAddress;
  ...
  OrderDetail({
    ...
    this.orderName,
    this.userName,
    this.userAddress, this.itemList,
...
//                                           ),
                              ...
                              children: [
                                  ...
                                  child: Row(
                                    children: [
                                      ClipRRect(
                                          ...
                                          child: Image.network("${widget.itemList![i].image}",height: 60,)),
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      "${widget.itemList![i].qty.toString()}",
                                      style: Theme.of(context).textTheme.titleSmall!.copyWith(
                                        fontFamily: 'PlusJakartaSans',
                                        color: black,
                                        fontSize: textFontSize14,
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      widget.itemList![i].name.toString(),
                                      style: Theme.of(context).textTheme.titleSmall!.copyWith(
                                        fontFamily: 'PlusJakartaSans',
                                        color: black,
                                        fontSize: textFontSize14,
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      "₹${widget.itemList![i].price.toString()}",
                                      style: Theme.of(context).textTheme.titleSmall!.copyWith(
                                        fontFamily: 'PlusJakartaSans',
                                        color: black,
                                        fontSize: textFontSize14,
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("User Details",style: TextStyle(color: primary,fontWeight: FontWeight.bold),),
                                Divider(color: Colors.black,),
                                // SizedBox(height: 5,),
                                // Padding(
                                //   padding: const EdgeInsets.only(bottom: 0.0),
                                ...
                                Row(
                                  children: [
                                    ...
                                    SizedBox(
                                      width: 170,
                                      child: Text(
                                        "${widget.userAddress.toString()}",maxLines: 2,
                                        style: Theme.of(context).textTheme.titleSmall!.copyWith(
                                          fontFamily: 'PlusJakartaSans',
                                          color: black,
                                          fontSize: textFontSize14,
  ...
  void _launchPhoneDialer() async {
    if (widget.mobile != null && await canLaunch("tel:${widget.mobile}")) {
